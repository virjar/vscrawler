 ...
 * @since 0.0.1
 */
public class VSCrawlerConstant {
    public static final String SESSION_POOL_MAX_IDLE = "sessionPool.maxIdle";
    public static final String SESSION_POOL_MIN_IDLE = "sessionPool.minIdl";
    public static final String SESSION_POOL_MAX_DURATION = "sessionPool.maxDuration";
    ...
    public static final String SEEION_POOL_USER_KEY = "sessionPool.userKEY";
